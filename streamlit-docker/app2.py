def app(): #individual test 
    ...
    if ints == opts[0]: #if they know their interest rate
        int_test = st.number_input('Please enter the interest rate you were previously approved for:',
        value = 12.00)
        ...
        credit_test = st.number_input('What is your current credit score?',
        value = 600)
        ...
        st.caption(f'Based on your credit score, your interest rate should be around {round(int_test, 2)}%')
        st.caption('Estimations of interest rate based on credit score may not yield accurate results.')
    else:
